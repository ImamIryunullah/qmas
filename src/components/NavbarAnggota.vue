<template>
  ...
  <div class="bg-red-600 text-white fixed top-0 left-0 z-50 transition-all duration-300"
    ...
    <div class="flex justify-between items-center mb-6 px-2">
      <span v-if="isSidebarOpen" class="ml-3 text-gray-200 font-bold text-lg">Anggota LPKNI</span>
    ...
    <div class="mt-auto pt-6 border-red-600">
      <router-link to="/anggota/profile"
        ...
        <span v-if="isSidebarOpen" class="ml-3 font-semibold">Profile</span>
      </router-link>
      <div v-if="isSidebarOpen" class="text-white-400 text-xs mt-4 ml-3 font-bold">
