            ...
            <ul class="hidden md:flex space-x-6">
                ...
                <li class="relative group">
                    ...
                    <ul
                        ...
                        <li>
                            <router-link to="#swi" class="fas fa-store block px-4 py-2 text-sm hover:bg-gray-200">
                                Daftar
            ...
            <ul class="flex flex-col items-center text-white space-y-6">
                ...
                <li class="relative group">
                    ...
                    <ul
                        ...
                        <li>
                            <router-link to="#swi" class="block px-4 py-2 text-sm hover:bg-gray-200">Daftar
                                Standar Warung Indonesia</router-link>
                        </li>
                    </ul>
                </li>
