            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-8">
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://www.instagram.com/lpkni_official/" target="_blank"
                            class="hover:text-gray-300"><i class="fab fa-instagram text-xl"></i></a>
                        <a href="https://www.youtube.com/user/ConsumersIntl" target="_blank"
                            class="hover:text-gray-300"><i class="fab fa-youtube text-xl"></i></a>
                ...
                <div>
                    ...
                    <p class="text-gray-300 mb-4">Subscribe to our LPKNI page to stay updated on our initiatives and
                        events.</p>
