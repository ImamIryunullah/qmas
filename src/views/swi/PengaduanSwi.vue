<template>
    ...
    <div v-if="isMounted" class="w-full min-h-screen flex justify-center items-center bg-green-100 text-xl p-4">
        ...
        <div class="flex flex-col items-center p-6 flex-grow">
            <div class="bg-white w-full max-w-screen-md p-6 rounded-lg border box-border animate-fadeInUp ">
                ...
                <p class="text-center text-gray-600 mt-2 text-sm md:text-base leading-relaxed">
                    <i class="fas fa-info-circle text-gray-500 mr-2 text-justify"></i>
                ...
                <form @submit.prevent="submitForm" class="space-y-6">
                    <!-- Nama Pengadu -->
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4 mt-12">
                        <label for="nama" class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Nama
                            Pengadu</label>
                    ...
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                        <label for="email"
                            class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Email</label>
                    ...
                    <!-- Provinsi -->
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                        <label class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Provinsi</label>
                    ...
                    <!-- Kota / Kabupaten -->
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                        <label class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Kota /
                            Kabupaten</label>
                    ...
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                        <label for="koordinat"
                            class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Koordinat :
                            lat,long</label>
                    ...
                    <div class="flex flex-col space-y-4 mb-4">
                        ...
                        <div class="flex flex-col sm:flex-row items-center space-x-4">
                            <!-- Kategori Pengaduan -->
                            <label for="kategori"
                                class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Kategori
                                Pengaduan</label>
                        ...
                        <div v-if="form.kategori === ''" class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                            <label for="keterangan-lainnya"
                                class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">
                                Keterangan Lainnya
                            </label>
                    ...
                    <!-- Judul Pengaduan -->
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                        <label for="judul" class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Judul
                            Pengaduan</label>
                    ...
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                        <label for="deskripsi"
                            class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Deskripsi
                            Pengaduan</label>
                        ...
                        <div v-for="(image, index) in imageInputs" :key="index" class="flex flex-col space-y-2 mb-4">
                            ...
                            <div class="flex flex-col sm:flex-row items-center justify-between w-full">
                                ...
                                <label class="block text-sm font-semibold w-full sm:w-1/3 text-left"
                                    :class="index === 0 ? 'text-green-700' : 'text-gray-500'">
                            ...
                            <div class="flex flex-col items-end">
                                <label v-if="imageUsers[index]"
                                    class="block text-center font-semibold text-green-700 text-sm w-full sm:w-auto">Bukti
                                    {{ index + 1 }}</label>
                    ...
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                        <label for="harapan" class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Harapan
                            Penyelesaian</label>
                    ...
                    <!-- Tindak Lanjut -->
                    <div class="flex flex-col sm:flex-row items-center space-x-4 mb-4">
                        <label for="publish" class="block text-sm font-semibold text-green-700 w-full sm:w-1/3">Apakah
                    ...
                    <div class="flex justify-center">
                        <button type="submit"
                            class="w-1/2 bg-green-600 text-white p-3 rounded-lg font-semibold hover:bg-green-700 transition-transform transform hover:scale-105">
                            Kirim
                        </button>
                    </div>
                </form>
