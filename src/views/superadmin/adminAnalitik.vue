  ...
  <div class="min-h-screen bg-gray-50">
      ...
      <nav class="bg-white shadow-sm border-b border-gray-200 px-4 py-4 lg:px-6">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-4">
            <select v-model="dateFilter" @change="updateAnalytics"
    ...
    <div v-if="showToast" class="fixed top-4 right-4 z-50 transition-all duration-300">
      <div :class="toastClass" class="px-4 py-3 rounded-lg shadow-lg flex items-center space-x-3">
        <svg v-if="toast.type === 'success'" class="w-5 h-5 text-green-400" fill="none" stroke="currentColor"
          viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        </svg>
        <svg v-else-if="toast.type === 'error'" class="w-5 h-5 text-red-400" fill="none" stroke="currentColor"
          viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
